...
export const USERS: Record<UserID, UserProfile> = {
  [UserID.PAOLO]: {
    ...
    // Corretto parametro top: 'shortFlat' (v9) invece di 'shortHairShortFlat'
    avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Felix&flip=true&top=shortFlat&hairColor=acacac&accessories=prescription02&facialHair=beardLight&clothing=blazerAndShirt&skinColor=edb98a"
  },
  [UserID.BARBARA]: {
    id: UserID.BARBARA,
    name: "Barbara",
    ...
    // Corretto parametro top: 'curvy' (v9) invece di 'longHairCurvy'
    avatar: "https://api.dicebear.com/9.x/avataaars/svg?seed=Aneka&top=curvy&hairColor=3e2021&accessories=prescription02&clothing=collarAndSweater&skinColor=edb98a"
  }
};
